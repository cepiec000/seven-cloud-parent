package com.seven.admin.aspectj;
...
import com.seven.comm.core.enums.BusinessStatus;
import com.seven.comm.core.enums.HttpMethod;
...
import com.seven.comm.web.utils.ip.IpUtils;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.seven.admin.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 保存数据库
            AsyncManager.me().execute(AsyncLogFactory.operation(operLog));
        } catch (Exception exp) {
            // 记录本地异常日志
            log.error("==前置通知异常==");
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLogEntity operLog) throws Exception {
        // 设置action动作
