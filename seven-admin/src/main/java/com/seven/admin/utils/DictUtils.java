...
public class DictUtils {
    ...
    public static List<SysDictDataEntity> getDictCache(String key) {
        ...
        if (StringUtils.isNotNull(cacheObj)) {
            List<SysDictDataEntity> dictDatas = StringUtils.cast(cacheObj);
            return dictDatas;
        }
        return null;
    }
    ...
    public static void clearDictCache() {
        Collection<String> keys = SpringUtils.getBean(RedisService.class).keys(AdminConstants.SYS_DICT_KEY + "*");
