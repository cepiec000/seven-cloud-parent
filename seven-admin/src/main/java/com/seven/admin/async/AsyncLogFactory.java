...
import com.seven.comm.core.utils.LogUtils;
import com.seven.comm.core.utils.SpringUtils;
import com.seven.comm.web.utils.ServletUtils;
import com.seven.comm.web.utils.ip.AddressUtils;
...
public class AsyncLogFactory
{
     ...
     * @return 任务task
     */
    public static TimerTask loginLog(final String username, final String status,final String message,  final Object... args) {
     ...
     * @return 任务task
     */
    public static TimerTask operation(final SysOperLogEntity operLog)
    {
        return new TimerTask()
        {
            @Override
